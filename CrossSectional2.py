...
def make_pipeline():
    ...
    shares_winsorized = shares.winsorize(min_percentile=0.05,    max_percentile=0.95)
    buy_back_winsorized = buy_back.winsorize(min_percentile=0.05,    max_percentile=0.95)
    ...
    debto_winsorized = debto.winsorize(min_percentile=0.05,    max_percentile=0.95)
